      ...
      <div className="hidden md:flex flex-col items-center justify-center w-full">
        <>
          ...
          <div className="flex items-center justify-center gap-14 h-10.5 bg-(--therapy-tips) w-full text-white font-normal">
            ...
            <a
              href={`${process.env.BASE_URL}/articles`}
              className="border-b border-transparent hover:border-white transition-all duration-200"
            >
              Articles
            </a>
            <a
              href={`${process.env.BASE_URL}/interviews`}
              className="border-b border-transparent hover:border-white transition-all duration-200"
            >
              Interviews
            </a>
            <a
              href={`${process.env.BASE_URL}/advice`}
              className="border-b border-transparent hover:border-white transition-all duration-200"
            >
              Advice
            </a>
            <a
              href={`${process.env.BASE_URL}/personality-tests`}
              className="border-b border-transparent hover:border-white transition-all duration-200"
            >
              Personality Tests
            </a>
            <a
              href={`${process.env.BASE_URL}/mental-health-topics-a-z`}
              className="border-b border-transparent hover:border-white transition-all duration-200"
            >
